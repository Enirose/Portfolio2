...
export default function MyProjects () {
  return (
      <Row className="allProject" id="projects">
        <Card className="CardProjects" style={{ width: '18rem' }}>
          ...
          <Card.Body>
            ...
            <Card.Text>
               A summer holiday accommodation website that has everything you need to make your summer vacation truly special.
            </Card.Text>
        ...
        <Card className="CardProjects" style={{ width: '18rem' }}>
        <Card.Img variant="top" src="https://github.com/Enirose/Tindahan-React_CA/assets/95321157/08d07cba-b52a-4752-a55a-ccf89ce1f457" alt="Online store" />
        <Card.Body>
          <Card.Title>Tindahan</Card.Title>
          <Card.Text>
        ...
        <Card className="CardProjects" style={{ width: '18rem' }}>
          <Card.Img variant="top" src="https://github.com/Enirose/Enirose/assets/95321157/1e05a1c4-8ff9-4e00-a8aa-d8b61e31d6a5" alt="Science museum"/>
          <Card.Body>
            <Card.Title>Science Museum</Card.Title>
            <Card.Text>
              Some quick example text to build on the card title and make up the
              bulk of the card's content.
            </Card.Text>
      ...
      <Card className="CardProjects" style={{ width: '18rem' }}>
        <Card.Img variant="top" src="https://github.com/Enirose/House-of-Bidders_Auction/assets/95321157/5738b8c6-2951-4709-9803-3f553924491f" alt="Auction site" />
        <Card.Body>
          <Card.Title>House of Bidders</Card.Title>
          <Card.Text>
            Some quick example text to build on the card title and make up the
            bulk of the card's content.
          </Card.Text>
